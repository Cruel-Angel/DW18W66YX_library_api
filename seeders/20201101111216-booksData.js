      ...
      [
        {
          ...
          status: "Approved",
          uploadBy: 1,
          file: "alice_oovjz0.epub",
          thumbnail: "Alice_kf4obo.jpg",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          status: "Approved",
          uploadBy: 1,
          file: "the_little_prince_rwh1az.epub",
          thumbnail: "Little_Prince.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          status: "Approved",
          uploadBy: 1,
          file: "gilgames_oua8ym.epub",
          thumbnail: "gilgamesh.jpg",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          status: "Approved",
          uploadBy: 1,
          file: "Beginning_CSS_Preprocessors_x4964r.epub",
          thumbnail: "Beginning_CSS_Preprocessors_tqdl3j.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          status: "Approved",
          uploadBy: 1,
          file: "Beginning_SQL_Queries_jv2z41.epub",
          thumbnail: "Beginning_SQL_Queries_lveeg1.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
Map/Reduce mechanism to identify patterns in the dataset.`,
          status: "Approved",
          uploadBy: 1,
          file: "Big_Data_Analytics_with_R_and_Hadoop_ynwgvr.epub",
          thumbnail: "Big_Data_Analytics_with_R_and_Hadoop_f8a4xb.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
`,
          status: "Approved",
          uploadBy: 1,
          file: "cpp_tutorial_xzmcui.epub",
          thumbnail: "c_tutorial_q5gh1y.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
flexbox, and 2017 began the rise of something called grid layout. Blend modes, box`,
          status: "Approved",
          uploadBy: 1,
          file: "CSS_in_Depth_yw4zpe.epub",
          thumbnail: "CSS_in_Depth_misdyw.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          status: "Approved",
          uploadBy: 1,
          file: "Data_Mining_Algorithms_in_C_jyd53b.epub",
          thumbnail: "Data_Mining_Algorithms_in_C_gujcuv.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
In this walkthrough, structured as a data science project, you will always be accompanied by clear code and simplified examples to help you understand the underlying mechanics and real-world datasets.`,
          status: "Approved",
          uploadBy: 1,
          file: "Data_Science_Essentials_in_Python_a4z332.epub",
          thumbnail: "Data_Science_Essentials_in_Python_uiwpao.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
the rise of a new generation of researchers.`,
          status: "Approved",
          uploadBy: 1,
          file: "deeplearningcookbook_s4ljmz.epub",
          thumbnail: "deeplearningcookbook_utgtyp.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
Ready? Set? Go!`,
          status: "Approved",
          uploadBy: 1,
          file: "JavaScript_Next_prwzt4.epub",
          thumbnail: "JavaScript_Next_zgihgm.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
I think you will find the book a comfortable balance between high-level introduction and concrete application, and by the end you should feel comfortable writing an entire application in Laravel, from scratch. And, if I did my job well, you’ll be excited to try.`,
          status: "Approved",
          uploadBy: 1,
          file: "laravel_up_and_running_byuvxa.epub",
          thumbnail: "laravel_up_and_running_n8wu9u.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
explained using examples for easy understanding.`,
          status: "Approved",
          uploadBy: 1,
          file: "ms_sql_server_tutorial_pyov5g.epub",
          thumbnail: "ms_sql_server_tutorial_wb0c9g.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
Using detailed examples at every step, you’ll learn how the MATTER Annotation Development Process helps you Model, Annotate, Train, Test, Evaluate, and Revise your training corpus. You also get a complete walkthrough of a real-world annotation project.`,
          status: "Approved",
          uploadBy: 1,
          file: "naturallanguageannotationformachinelearning_basjkn.epub",
          thumbnail: "naturallanguageannotationformachinelearning_g08obb.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
`,
          status: "Approved",
          uploadBy: 1,
          file: "postgresql_tutorial_z512da.epub",
          thumbnail: "postgresql_tutorial_lrw6f5.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
You’ll first cover the fundamentals of databases and the SQL language, then build skills by analyzing data from the U.S. Census and other federal and state government agencies. With exercises and real-world examples in each chapter, this book will teach even those who have never programmed before all the tools necessary to build powerful databases and access information quickly and efficiently.`,
          status: "Approved",
          uploadBy: 1,
          file: "Practical_SQL__A_Beginner_s_Guide_iom4uz.epub",
          thumbnail: "Practical_SQL__A_Beginner_s_Guide_qiih2r.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
...
If you’re familiar with R or Python, know a bit of statistics, and have some experience manipulating data, author Darren Cook will take you through H2O basics and help you conduct machine-learning experiments on different sample data sets. You’ll explore several modern machine-learning techniques such as deep learning, random forests, unsupervised learning, and ensemble learning.`,
          status: "Approved",
          uploadBy: 1,
          file: "practicalmachinelearningwithh2o_ufmo5s.epub",
          thumbnail: "practicalmachinelearningwithh2o_izmzv4.png",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
      ],
